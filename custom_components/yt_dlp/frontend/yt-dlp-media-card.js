      ...
      <ha-card class="card ${isPlaying ? "is-playing" : ""}" style="${this._presetVars()}">
        ...
        <div class="surface">
          <header>
            ...
            ${activityStatus ? `<div class="activity-badge ${activityStatus.className}">${this._icon(activityStatus.icon)}<span class="activity-label">${this._escape(activityStatus.label)}</span></div>` : ""}
          </header>
  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}button,input,select{font:inherit}button{color:inherit}
      ...
      header{justify-content:space-between;gap:12px;min-width:0}.brand{gap:12px;min-width:0}.brand>div:last-child{min-width:0}.brand-icon{width:44px;height:44px;flex:0 0 44px;border-radius:14px;display:grid;place-items:center;background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;box-shadow:0 8px 24px color-mix(in srgb,var(--accent) 30%,transparent)}.brand-icon ha-icon{--mdc-icon-size:26px}.eyebrow{font-size:clamp(8px,2.2cqi,10px);font-weight:800;letter-spacing:.16em;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.brand-title{font-size:clamp(15px,4cqi,18px);font-weight:800;letter-spacing:-.02em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.activity-badge{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;height:28px;padding:0 9px;gap:6px;border:1px solid transparent;border-radius:9px;font-size:10px;font-weight:800;letter-spacing:.01em;line-height:1;white-space:nowrap;box-shadow:0 2px 8px rgba(0,0,0,.08);backdrop-filter:blur(8px)}.activity-badge>ha-icon{--mdc-icon-size:14px}.activity-label{white-space:nowrap}.activity-badge.playing{color:#21b779;background:color-mix(in srgb,#21b779 11%,var(--card-bg));border-color:color-mix(in srgb,#21b779 24%,transparent)}.activity-badge.playing>ha-icon{animation:statusPulse 1.8s ease-in-out infinite}.activity-badge.downloading{color:color-mix(in srgb,var(--accent) 88%,#fff 12%);background:color-mix(in srgb,var(--accent) 12%,var(--card-bg));border-color:color-mix(in srgb,var(--accent) 26%,transparent)}.activity-badge.downloading>ha-icon{animation:downloadFloat 1.25s ease-in-out infinite}.activity-badge.paused{color:#d49a32;background:color-mix(in srgb,#d49a32 11%,var(--card-bg));border-color:color-mix(in srgb,#d49a32 24%,transparent)}
